...
Employee Portal role assignments are checked against database-backed SoD policies before Keycloak access changes. Deny decisions take priority; both deny and review-required decisions block assignment and are audited. Review-required decisions do not yet create approval requests.

See the [identity model's SoD documentation](docs/identity-model.md#17-segregation-of-duties) for seeded policies, evaluation behavior, audit events, validation, and limitations.
